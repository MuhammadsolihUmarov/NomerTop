export const translations = {
  en: {
    ...
    auth: {
      ...
      passAuthDesc: 'Enter your phone number and password.',
      otpAuthDesc: 'Enter your phone number and SMS code.',
      phoneLabel: 'Phone number',
      passLabel: 'Password',
      requestCode: 'Send code',
      resendCode: 'Resend',
      initializeSession: 'LOG IN',
      establishLink: 'CONFIRM',
      loginModePass: 'Password',
      loginModeOtp: 'SMS code',
      signupTitle: 'Create account',
      signupSub: 'Quick, free, anonymous.',
      switchToOtp: 'Use SMS code instead →',
      switchToPass: '← Use password instead'
    },
    registration: {
  ...
  ru: {
    ...
    auth: {
      ...
      passAuthDesc: 'Введите телефон и пароль.',
      otpAuthDesc: 'Введите телефон и код из SMS.',
      phoneLabel: 'Номер телефона',
      passLabel: 'Пароль',
      requestCode: 'Получить код',
      resendCode: 'Отправить снова',
      initializeSession: 'ВОЙТИ',
      establishLink: 'ПОДТВЕРДИТЬ',
      loginModePass: 'Пароль',
      loginModeOtp: 'SMS код',
      signupTitle: 'Создать аккаунт',
      signupSub: 'Быстро, бесплатно, анонимно.',
      switchToOtp: 'Войти через SMS →',
      switchToPass: '← Войти с паролем'
    },
    registration: {
  ...
  uz: {
    ...
    auth: {
      ...
      switchToOtp: 'SMS kod bilan kirish →',
      switchToPass: '← Parol bilan kirish'
    },
    registration: {
